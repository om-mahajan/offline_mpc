#!/usr/bin/env python3
"""
Evaluation script for saved Flow Matching models.
Evaluates models at every 20000th training step.
"""
...
def evaluate_episode(env, model, device, norm_fn, diffusion_steps=15, horizon=5, act_dim=None, max_steps=1000, debug=False):
    """
    Evaluate a single episode using the flow model.
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Evaluate saved Flow Matching models")
    ...
    if args.output_file is None:
        ...
        output_dir = run_dir
        output_file = osp.join(output_dir, f"eval_results_step{args.step_interval}.json")
    else:
